...
const Hero = () => {
  ...
  const getVideoSrc = (index) => `videos/Video.mp4`;
  ...
  return (
    <div className="relative h-dvh w-screen overflow-x-hidden">
      ...
      >
        ...
        <h1 className="special-font hero-heading absolute bottom-5 right-5 z-40 text-blue-75" style={{
        ...
        <div className="absolute left-0 top-0 z-40 size-full">
          ...
          <h1 className="mt-32 hero-heading text-blue-100" style={{
              fontFamily: "'Poppins', sans-serif", 
              fontSize: "90px", 
              fontWeight: "bold",
          }}>
